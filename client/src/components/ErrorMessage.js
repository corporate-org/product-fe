  ...
  return (
    <div className={props.message ? "error-message" : "hidden-error-message"}>
      ...
      <ul>
        ...
        <li>In <span className="bold">Variables</span>, define an environment variable for your database connection with a key <span className="highlight">CONNECTION_STRING</span> and value: <span className="highlight">{'${externals.postgres.host};${externals.postgres.name};${externals.postgres.username};${externals.postgres.password};${externals.postgres.port}'}</span></li>
